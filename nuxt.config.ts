...
// site env
const siteConfig = {
  siteTitle: process.env.SITE_TITLE || "站点监测",
  ...
  siteGithub: process.env.GITHUB_NAME || "",
  siteHomepage: process.env.HOME_URL || "",
  siteEmail: process.env.EMAIL_ADDR || "",
  siteCopyright: process.env.COPYRIGHT_TEXT || "",
